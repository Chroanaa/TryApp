...
function VanDetails() {
  ...
  const [gettingVanDetails, setGettingVanDetails] = useState(null);
  useEffect(() => {
  ...
  return gettingVanDetails ? (
    ...
    >
      <NavLink
        to={"/vans"}
        className="flex flex-row underline decoration-white ml-12 transition-all hover:decoration-blue hover:scale-105 underline-offset-4 decoration-2 duration-500"
      >
